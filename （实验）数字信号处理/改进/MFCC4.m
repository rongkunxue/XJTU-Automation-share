...
bank=melbankm(24,1024,fs,0,0.5,'m');%Mel滤波器的阶数为24，fft变换的长度为256，采样频率为8000Hz  
...
c1=dctcoef*log(bank*t(1:513));%对能量谱滤波及DCT %t(1:129)对一帧的前128个数（帧移为128）
