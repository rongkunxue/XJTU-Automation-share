...
void main(void)
{
	...
	while(1U)
	{
		...
		{
		dispaly(0);        				/*digital_led display button number*/
		flag_digital_led = 0;
		}
		Keyboard_scan();  					/*scan which button pressed*/
		if(flag_digital_led==1)
		{
		dispaly(1);        				/*digital_led display button number*/
		flag_digital_led = 0;
		}
		Keyboard_scan();  					/*scan which button pressed*/
		if(flag_digital_led==1)
		{
		dispaly(2);        				/*digital_led display button number*/
		flag_digital_led = 0;
		}
	}    
