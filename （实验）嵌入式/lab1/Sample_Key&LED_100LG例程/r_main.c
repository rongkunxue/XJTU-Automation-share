...
extern volatile uint8_t resultt;
uint8_t array_key[3];
uint8_t  count=0;
...
void dispaly(void)
{
	array_key[2]=resultt/100;    //the front char
	array_key[1]=(resultt-array_key[2]*100)/10;    //the front char
	array_key[0]=resultt - array_key[2] * 100 - array_key[1] * 10;
	if(count<3)
	{
