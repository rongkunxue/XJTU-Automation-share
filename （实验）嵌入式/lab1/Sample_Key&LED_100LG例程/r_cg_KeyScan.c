...
volatile uint8_t num_keyboard2;
volatile uint8_t resultt=0;
...
void Keyboard_scan(void)
{
	...
	if(temp!=0xf0)    							/*first check*/
	{
		...
		if(temp!=0xf0)							/*second check*/
		{
			...
			case 0x70:  num_keyboard=13; resultt = 0; break;
			}
		}
	...
	if(temp!=0xf0)
	{
		...
		case 0xb0:  num_keyboard=10; resultt = 0; break;
		case 0x70:  num_keyboard=14; resultt = 0; break;
		}
		}
	}
	...
	if(temp!=0xf0)
	{
		...
		case 0xb0:  num_keyboard=11; resultt = 0; break;
		case 0x70:  num_keyboard=15;  resultt = 0;break;
		}
		}
	}
	...
	if(temp!=0xf0)
	{
		...
		case 0xb0:  num_keyboard=12; resultt = 0; break;
		case 0x70:  num_keyboard=0; break;
		}
		}
	}
	if(num_keyboard != key_tmp) resultt = resultt * 10 + num_keyboard;
	//num_keyboard = num_keyboard * 2;
/*	switch(rate)
	{
		case 0: num_keyboard*=100; break;
		case 1: num_keyboard*=10; break;
		case 2: num_keyboard*=1;break;
	}
	if(rate == 2) rate = 0;
	else rate++;*/
